...
class AdminHealthcheckGet200Response(BaseModel):
    """
    AdminHealthcheckGet200Response
    """ # noqa: E501
    status: Optional[StrictStr] = None
    dbconnection: Optional[StrictStr] = None
    n_stations: Optional[StrictInt] = None
    n_tags: Optional[StrictInt] = None
    n_passes: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["status", "dbconnection", "n_stations", "n_tags", "n_passes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "n_stations": obj.get("n_stations"),
            "n_tags": obj.get("n_tags"),
            "n_passes": obj.get("n_passes")
        })
        return _obj
